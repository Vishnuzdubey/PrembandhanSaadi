      ...
      <header className="sticky top-0 z-50 w-full border-b bg-white/95 backdrop-blur-md supports-[backdrop-filter]:bg-white/90 shadow-sm">
        <div className="container mx-auto flex h-20 items-center justify-between px-4">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#" className="text-sm font-semibold hover:text-rose transition-colors duration-200 relative group">
              How It Works
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Button variant="ghost" size="sm" className="font-semibold hover:bg-rose/10">
          ...
          <div className="md:hidden border-t bg-white/95 backdrop-blur-md">
            <div className="container mx-auto px-4 py-4 space-y-4">
              ...
              <nav className="space-y-3">
                <a href="#" className="block text-sm font-semibold hover:text-rose transition-colors py-2">
                  How It Works
                </a>
                <a href="#" className="block text-sm font-semibold hover:text-rose transition-colors py-2">
                  Success Stories
