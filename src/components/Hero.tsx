  ...
  return (
    <>
      ...
      <div className="relative z-10 text-center text-white px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        {/* Premium Badge */}
        <div className="inline-flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-3 sm:px-4 py-2 mb-4 sm:mb-6">
          <Star className="w-3 h-3 sm:w-4 sm:h-4 text-gold fill-gold" />
          <span className="text-xs sm:text-sm font-medium">India's Most Trusted Matrimonial Platform</span>
          <Star className="w-3 h-3 sm:w-4 sm:h-4 text-gold fill-gold" />
        </div>
        ...
        <div className="flex justify-center px-4">
          <div className="inline-flex items-center gap-1 sm:gap-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full px-3 sm:px-6 py-2 sm:py-3">
            <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-gold flex-shrink-0" />
            <span className="text-xs sm:text-sm font-medium text-center">
              <span className="hidden sm:inline">SSL Secured • Privacy Guaranteed • Verified Profiles</span>
              <span className="sm:hidden">Secure & Verified</span>
            </span>
          </div>
        </div>
      </div>
